...
class TestCompositeGameMotion(unittest.TestCase):
    ...
    def test_composite_game_motion(self):
        ...
        # 各ゲーム動作のインスタンスを生成
        b2i = BlockToIntersection(45, Color.RED, True, False)
        b2m = BlockToMiddle(90, True, False)
        i2b = IntersectionToBlock(135, True, False, True, False, False)
        i2m = IntersectionToMiddle(180, True, True, False)
        m2b = MiddleToBlock(-45, True, True, False)
        m2i = MiddleToIntersection(-90, Color.BLUE, False, False)
        m2m = MiddleToMiddle(-135, True, False, False)
