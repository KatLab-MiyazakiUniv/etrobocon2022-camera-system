...
class TestGameAreaInfo(unittest.TestCase):
    ...
    #         Node(0, Coordinate(5, 1), block_storage), Node(0, Coordinate(1, 3), block_storage),
    #         Node(0, Coordinate(5, 3), block_storage), Node(0, Coordinate(1, 5), block_storage),
    #         Node(0, Coordinate(3, 5), block_storage), Node(0, Coordinate(5, 5), block_storage)
    #     ]
